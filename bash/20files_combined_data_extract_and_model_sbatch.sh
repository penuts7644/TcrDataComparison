...
cp "${SLURM_SUBMIT_DIR}/BruskoT1D/PB/MC/Brusko_5824_TCRB.tsv" data/.
cp "${SLURM_SUBMIT_DIR}/BruskoT1D/PB/MC/Brusko_18804_TCRB.tsv" data/.
cp "${SLURM_SUBMIT_DIR}/BruskoT1D/PB/MC/Brusko_7273_TCRB.tsv" data/.
cp "${SLURM_SUBMIT_DIR}/BruskoT1D/PB/MC/Brusko_7482_TCRB.tsv" data/.
cp "${SLURM_SUBMIT_DIR}/BruskoT1D/PB/MC/Brusko_27316_TCRB.tsv" data/.
cp "${SLURM_SUBMIT_DIR}/BruskoT1D/PB/MC/Brusko_17471_TCRB.tsv" data/.
cp "${SLURM_SUBMIT_DIR}/BruskoT1D/PB/MC/Brusko_9542_TCRB.tsv" data/.
cp "${SLURM_SUBMIT_DIR}/BruskoT1D/PB/MC/Brusko_6173_TCRB.tsv" data/.
cp "${SLURM_SUBMIT_DIR}/BruskoT1D/PB/MC/Brusko_2845_TCRB.tsv" data/.
cp "${SLURM_SUBMIT_DIR}/BruskoT1D/PB/MC/Brusko_4057_TCRB.tsv" data/.
cp "${SLURM_SUBMIT_DIR}/BruskoT1D/PB/MC/Brusko_10232_TCRB.tsv" data/.
cp "${SLURM_SUBMIT_DIR}/BruskoT1D/PB/MC/Brusko_23067_TCRB.tsv" data/.
cp "${SLURM_SUBMIT_DIR}/BruskoT1D/PB/MC/Brusko_10168_TCRB.tsv" data/.
cp "${SLURM_SUBMIT_DIR}/BruskoT1D/PB/MC/Brusko_24162_TCRB.tsv" data/.
cp "${SLURM_SUBMIT_DIR}/BruskoT1D/PB/MC/Brusko_5549_TCRB.tsv" data/.
cp "${SLURM_SUBMIT_DIR}/BruskoT1D/PB/MC/Brusko_16224_TCRB.tsv" data/.
cp "${SLURM_SUBMIT_DIR}/BruskoT1D/PB/MC/Brusko_5511_TCRB.tsv" data/.
cp "${SLURM_SUBMIT_DIR}/BruskoT1D/PB/MC/Brusko_10332_TCRB.tsv" data/.

# Mark the output dir for automatic copying to $SLURM_SUBMIT_DIR afterwards
savefile immuno_probs_combined

# Create the job dir for the output files
mkdir immuno_probs_combined
cd immuno_probs_combined

# Extract the data files from the Brusko data file
python ../SequenceDataExtractor.py --num-threads ${OMP_NUM_THREADS} "../data" '../human_TRB/TRBV.fasta' '../human_TRB/TRBJ.fasta' '\t' &> 'sequence_extract_log.txt'

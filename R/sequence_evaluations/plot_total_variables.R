...
model_0_all <- data.frame(read.table('~/Downloads/evaluated_seqs/evaluate_0/pgen_estimate_all_CDR3.tsv', header=TRUE, row.names=1, sep='\t', check.names=FALSE, colClasses=cc))
...
model_1_productive <- data.frame(read.table('~/Downloads/evaluated_seqs/evaluate_1/pgen_estimate_productive_CDR3.tsv', header=TRUE, row.names=1, sep='\t', check.names=FALSE, colClasses=cc))
model_1_unproductive <- data.frame(read.table('~/Downloads/evaluated_seqs/evaluate_1/pgen_estimate_unproductive_CDR3.tsv', header=TRUE, row.names=1, sep='\t', check.names=FALSE, colClasses=cc))
model_1_all <- data.frame(read.table('~/Downloads/evaluated_seqs/evaluate_1/pgen_estimate_all_CDR3.tsv', header=TRUE, row.names=1, sep='\t', check.names=FALSE, colClasses=cc))
...
model_2_productive <- data.frame(read.table('~/Downloads/evaluated_seqs/evaluate_2/pgen_estimate_productive_CDR3.tsv', header=TRUE, row.names=1, sep='\t', check.names=FALSE, colClasses=cc))
model_2_unproductive <- data.frame(read.table('~/Downloads/evaluated_seqs/evaluate_2/pgen_estimate_unproductive_CDR3.tsv', header=TRUE, row.names=1, sep='\t', check.names=FALSE, colClasses=cc))
model_2_all <- data.frame(read.table('~/Downloads/evaluated_seqs/evaluate_2/pgen_estimate_all_CDR3.tsv', header=TRUE, row.names=1, sep='\t', check.names=FALSE, colClasses=cc))
...
model_3_productive <- data.frame(read.table('~/Downloads/evaluated_seqs/evaluate_3/pgen_estimate_productive_CDR3.tsv', header=TRUE, row.names=1, sep='\t', check.names=FALSE, colClasses=cc))
model_3_unproductive <- data.frame(read.table('~/Downloads/evaluated_seqs/evaluate_3/pgen_estimate_unproductive_CDR3.tsv', header=TRUE, row.names=1, sep='\t', check.names=FALSE, colClasses=cc))
model_3_all <- data.frame(read.table('~/Downloads/evaluated_seqs/evaluate_3/pgen_estimate_all_CDR3.tsv', header=TRUE, row.names=1, sep='\t', check.names=FALSE, colClasses=cc))
...
model_4_productive <- data.frame(read.table('~/Downloads/evaluated_seqs/evaluate_4/pgen_estimate_productive_CDR3.tsv', header=TRUE, row.names=1, sep='\t', check.names=FALSE, colClasses=cc))
model_4_unproductive <- data.frame(read.table('~/Downloads/evaluated_seqs/evaluate_4/pgen_estimate_unproductive_CDR3.tsv', header=TRUE, row.names=1, sep='\t', check.names=FALSE, colClasses=cc))
model_4_all <- data.frame(read.table('~/Downloads/evaluated_seqs/evaluate_4/pgen_estimate_all_CDR3.tsv', header=TRUE, row.names=1, sep='\t', check.names=FALSE, colClasses=cc))
...
model_combined_productive <- data.frame(read.table('~/Downloads/evaluated_seqs/evaluate_combined/pgen_estimate_productive_CDR3.tsv', header=TRUE, row.names=1, sep='\t', check.names=FALSE, colClasses=cc))
model_combined_unproductive <- data.frame(read.table('~/Downloads/evaluated_seqs/evaluate_combined/pgen_estimate_unproductive_CDR3.tsv', header=TRUE, row.names=1, sep='\t', check.names=FALSE, colClasses=cc))
model_combined_all <- data.frame(read.table('~/Downloads/evaluated_seqs/evaluate_combined/pgen_estimate_all_CDR3.tsv', header=TRUE, row.names=1, sep='\t', check.names=FALSE, colClasses=cc))
